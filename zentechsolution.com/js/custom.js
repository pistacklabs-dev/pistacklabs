        ...
        jQuery(window).on('scroll', function() {
            if (jQuery('.sticky-header').length > 0) {
                ...
                if ($(window).scrollTop() > menu.offset().top) {
                    ...
                    $('.site-header .container > .logo-header .logo').attr('src', 'images/zentech_solutions_Final_Logo.svg');
                    $('.site-header .container > .logo-header .logo-2').attr('src', 'images/zentech_solutions_Final_Logo.svg');
                    $('.site-header .container > .logo-header .logo-3').attr('src', 'images/logo-3.png');
                } else {
                    menu.removeClass('is-fixed');
                    $('.site-header .container > .logo-header .logo, .site-header .container > .logo-header .logo-2, .site-header .container > .logo-header .logo-3').attr('src', 'images/zentech_solutions_Final_Logo_white.svg')
                }
            }
        });
    ...
    accordions.forEach((button, index) => {
        ...
        button.addEventListener("click", function() {
            ...
            if (isOpen) {
                ...
                content.style.maxHeight = "max-content"; // Set max-height dynamically
                content.style.paddingTop = "10px";
                content.style.paddingBottom = "10px";
            }
        });
